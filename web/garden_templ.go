...
func gardenFields(g *models.Garden) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		var templ_7745c5c3_Var21 = []any{ContainerSecondary(), Padded()}
		...
		var templ_7745c5c3_Var24 = []any{ContainerSecondary(), Padded(), LocationField()}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `web/garden.templ`, Line: 53, Col: 76}
		}
		...
		if g.Description != "" {
			var templ_7745c5c3_Var27 = []any{ContainerSecondary(), Padded(), DescriptionField()}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `web/garden.templ`, Line: 56, Col: 82}
			}

...
func gardenInventory(g *models.Garden) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		var templ_7745c5c3_Var30 = []any{nav}
		...
		var templ_7745c5c3_Var32 = []any{btn, gardenCreateLink, "hover-primary"}
		...
		var templ_7745c5c3_Var34 templ.SafeURL = templ.URL(fmt.Sprintf("/gardens/%s/inventory/new", g.Id()))
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(string(templ_7745c5c3_Var34)))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("\">Add</a></nav><div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		for _, i := range g.Inventory {
			...
			templ_7745c5c3_Var35, templ_7745c5c3_Err = templ.JoinStringErrs(i.Name)
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `web/garden.templ`, Line: 68, Col: 15}
			}
